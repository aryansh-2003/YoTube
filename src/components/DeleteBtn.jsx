...
export default function DeleteBtn({videoId}) {
  const [open, setOpen] = useState(false)
  const navigate = useNavigate()

    const onclick = () =>{
        VideoService.deleteVideo({id : videoId}).then((res)=>{
            console.log(res)
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        Are you sure you want to delete your Video? Your video will be permanently removed.
